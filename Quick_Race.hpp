...
void PlayGame()
{
    ...
    sf::Image image11;
    image11.LoadFromFile("images/nitrous.png"); //nitrous

    sf::Image image12;
    image12.LoadFromFile("images/invisibility.png"); //invisibility

    sf::Image image13;
    image13.LoadFromFile("images/ditch.png"); //ditch

    sf::Image image14;
    image14.LoadFromFile("images/thorn.png"); //thorn
    ...
    sf::Sprite sprite3_1;
    sf::Sprite sprite4;
    sf::Sprite sprite4_1;                   //blue car
    sf::Sprite sprite5;
    sf::Sprite sprite5_1;                   //red car
    ...
    while(running)
    {
        ...
        if(speed>10)
        {
            ...
            if(randomno==1)
            {
                ...
                sprite3.SetPosition(randomx, -50);
                Clock1.Reset();
            }
            ...
            if(randomno==2)
            {
                ...
                sprite4.SetPosition(randomx, -50);
                Clock1.Reset();
            }
            ...
            if(randomno==3)
            {
                ...
                int randomx = sf::Randomizer::Random(50, 200);
                sprite5.SetPosition(randomx, -50);
                Clock1.Reset();
            }
        ...
        if(clock_fuel.GetElapsedTime() >= 7)
         {

                int randomx = sf::Randomizer::Random(50, 200);
                sprite10.SetImage(image10);
                sprite10.SetPosition(randomx, -50);
                clock_fuel.Reset();
        }
        ...
        {
            int randompower = sf::Randomizer::Random(1,5);
            int random_x = sf::Randomizer::Random(50, 200);
            ...
            switch(randompower)
            {
                ...
                sprite7.SetPosition(random_x, -100);
                Clock_Point.Reset();
                break;
                ...
                sprite11.SetImage(image11);
                sprite11.SetPosition(random_x, -100);
                Clock_Point.Reset();
                break;

                case 3:
                sprite12.SetImage(image12);
                sprite12.SetPosition(random_x, -100);
                Clock_Point.Reset();
                break;

                case 4:
                sprite13.SetImage(image13);
                sprite13.SetPosition(random_x, -100);
                Clock_Point.Reset();
                break;


                case 5:
                sprite14.SetImage(image14);
                sprite14.SetPosition(random_x, -100);
                Clock_Point.Reset();
                break;
        ...
        if (Window1.GetInput().IsKeyDown(sf::Key::Up))
         {
            ...
            sprite10.Move(0, 75 * ElapsedTime);
            sprite11.Move(0, 75 * ElapsedTime);
            sprite12.Move(0, 75 * ElapsedTime);
            sprite13.Move(0, 75 * ElapsedTime);
            sprite14.Move(0, 75 * ElapsedTime);
        ...
        else
        {
            ...
            sprite11.Move(0, 50* ElapsedTime);
            sprite12.Move(0, 50* ElapsedTime);
            sprite13.Move(0, 50* ElapsedTime);
            sprite14.Move(0, 50* ElapsedTime);
        ...
        if(hitscore>=1000)
        {
             if(speed>3)
                ...
                int randomno = sf::Randomizer::Random(1, 6); //generate random numbers between 1 and 3
                ...
                if(randomno==4)
                {
                    sprite5_1.SetImage(image5);
                    int randomx = sf::Randomizer::Random(50, 200);
                    sprite5_1.SetPosition(randomx, -150);
                    Clock1.Reset();
                }
                if(randomno==5)
                {
                    sprite4_1.SetImage(image4);
                    int randomx = sf::Randomizer::Random(50, 200);
                    sprite4_1.SetPosition(randomx, -150);
                    Clock1.Reset();
                }
                if(randomno==6)
                {
                    sprite3_1.SetImage(image3);
                    int randomx = sf::Randomizer::Random(50, 200);
                    sprite3_1.SetPosition(randomx, -150);
                    Clock1.Reset();
                }
        ...
        Window1.Draw(sprite3_1);
        Window1.Draw(sprite4);
        Window1.Draw(sprite4_1);
        Window1.Draw(sprite5);
        Window1.Draw(sprite5_1);
        Window1.Draw(sprite7);
        Window1.Draw(score);
        Window1.Draw(fuel);
        Window1.Draw(sprite8);
        Window1.Draw(sprite10);
        Window1.Draw(sprite11);
        Window1.Draw(sprite12);
        Window1.Draw(sprite13);
        Window1.Draw(sprite14);
